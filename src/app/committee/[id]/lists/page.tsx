          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {lists.map(list => (
              <div key={list.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-5 flex items-start justify-between border-l-4 border-indigo-500">
                ...
                {isHead && (
                  <button onClick={() => deleteList(list.id)} className="p-2.5 text-gray-500 hover:text-red-500 hover:bg-red-50 rounded transition-colors shrink-0" title="Delete list" aria-label="Delete list">
